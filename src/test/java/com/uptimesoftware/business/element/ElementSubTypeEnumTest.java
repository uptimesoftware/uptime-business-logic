...
public class ElementSubTypeEnumTest {
	...
	public void netSwitch() {
		assertEquals(ElementSubTypeEnum.Switch, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.Node, null, null, null));
	}

	@Test
	public void application() {
		assertEquals(ElementSubTypeEnum.Application,
				ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.Application, null, null, null));
	}

	@Test
	public void windows() {
		assertEquals(ElementSubTypeEnum.Windows, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
		...
		assertEquals(ElementSubTypeEnum.Windows, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.VmwareObject,
				EntitySubTypeEnum.VirtualMachine, "Microsoft Windows Server 2008 (64-bit)", null));
	}

	@Test
	public void linux() {
		assertEquals(ElementSubTypeEnum.Linux, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
		...
		assertEquals(ElementSubTypeEnum.Linux, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.VmwareObject,
	...
	@Test
	public void novell() {
		assertEquals(ElementSubTypeEnum.Netware, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
				EntitySubTypeEnum.NovellNrm, "Server Version 5.70.05, December 16, 2005", null));
	}

	@Test
	public void aix() {
		assertEquals(ElementSubTypeEnum.Aix, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System, EntitySubTypeEnum.Agent,
				"AIX qa-aix61 1 6 00CA027D4C00", "6.1"));
	}

	@Test
	public void solaris() {
		assertEquals(ElementSubTypeEnum.Solaris, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
	...
	@Test
	public void hpux() {
		assertEquals(ElementSubTypeEnum.Hpux, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System, EntitySubTypeEnum.Agent,
	...
	public void esxServer() {
		assertEquals(ElementSubTypeEnum.EsxServer, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
				EntitySubTypeEnum.VmwareEsx, "VMware ESXi 5.0.0 build-768111", "VMware ESXi 5.0.0 build-768111"));
	}

	@Test
	public void ibmPower() {
		assertEquals(ElementSubTypeEnum.IbmPowerSystems, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
				EntitySubTypeEnum.LparHmc, "9110-51A", "HMC v7 R7.1.0.2 build 20100510.1"));
	}

	@Test
	public void unknown() {
		assertEquals(ElementSubTypeEnum.Unknown, ElementSubTypeEnum.fromElementConfiguration(EntityTypeEnum.System,
